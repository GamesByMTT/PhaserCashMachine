...
export default class Disconnection extends Scene{
    ...
    create(){
        ...
        const disconnectionText = this.add.text( this.popupBackground.x, this.popupBackground.y - 70, "Unable to connect to server", {color: "#809ed9", fontFamily:"crashLandingItalic", fontSize: '85px', stroke: "#4f3130",
        ...
        this.ButtonText = this.add.text(gameConfig.scale.width/2 - 60, gameConfig.scale.height/2 + 60, "Close", {color: "#809ed9", fontFamily:"crashLandingItalic", fontSize: '65px', stroke: "#4f3130",
